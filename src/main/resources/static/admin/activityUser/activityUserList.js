...
layui.use(['laydate','admin','form', 'jquery', 'table', 'js_tools'], function () {
    ...
    option.url = "/admin/api/activityUser/page";
    option.cols = [[
    ...
    window.activityUserListIns = table.render(option);
    ...
    table.on('tool(list)', function (obj) {
        ...
        if (obj.event === 'edit') {
            // 编辑功能
            WeAdminEdit('编辑','./activityUserEdit.html',data.id);
        } else if (obj.event === 'del') {
            //删除功能
            js_tools.quick_post("/admin/api/activityUser/delete",data,function (rs) {
    ...
    form.on('submit(search)', function(data){
        ...
        activityUserListIns.reload({where:data.field});
